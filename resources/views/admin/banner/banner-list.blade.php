...
<div class="x-body">
    <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="banner_add('添加用户','{{url('Admin/ad/create')}}','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
        ...
        <tr>
            ...
            <td class="td-status">
                            <span class="layui-btn layui-btn-normal layui-btn-mini">
                                @if($item->status == 1) 已显示 @else  不显示 @endif
                            </span>
            </td>
            <td class="td-manage">
                ...
                <a title="编辑" href="javascript:;" onclick="banner_edit('编辑','{{url('Admin/banner-edit')}}','4','','510')"
